...
class DebugSQLInterpreter : public ISQLInterpreter
{
...
public:
    explicit DebugSQLInterpreter(const SQLInterpreter &sqlInterpreter, const PersistentStorage &persistentStorage, const PathProvider &pathProvider) : sqlInterpreter_(sqlInterpreter), persistentStorage_(persistentStorage), pathProvider_(pathProvider) {}
